...
public class GetProductAdCategoriesRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public GetProductAdCategoriesRequest(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener){
        setValues();
        volleyLIbUtils=new VolleyLIbUtils(context,methodId,url,listener,errorListener);
    }
    private void setValues(){
        url= Constants.basicUrl+"/productAdCategories";
