...
public class RatingClinicRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public RatingClinicRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
    ...
    private void setValues(int user_id,int id){
        url= Constants.basicUrl+"/clinics/"+id+"/users/"+user_id+"/rate";
