...
public class DeleteJobAdFromFavouriteRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public DeleteJobAdFromFavouriteRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
    ...
    private void setValues(int user_id,int id){
        url= Constants.basicUrl+"/job-ads/"+id+"/users/"+user_id+"/fav";
