...
public class RatingCosmeticClinicsRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public RatingCosmeticClinicsRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
    ...
    private void setValues(int user_id,int id){
        url= Constants.basicUrl+"/cosmetic-clinics/"+id+"/users/"+user_id+"/rate";
