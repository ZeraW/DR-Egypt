...
public class ViewsIncrementForHospitalRequest {
    ...
    public ViewsIncrementForHospitalRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
    ...
    private void setValues(int user_id,int id){
        url= Constants.basicUrl+"/hospitals/"+id+"/users/"+user_id+"/view";
