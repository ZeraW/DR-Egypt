...
public class AddPharmacyToFavouriteRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public AddPharmacyToFavouriteRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
