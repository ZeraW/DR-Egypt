...
public class GetHospitalSpecialitiesRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public GetHospitalSpecialitiesRequest(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener){
        setValues();
