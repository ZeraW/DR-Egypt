...
public class GetJobAdCategoriesRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public GetJobAdCategoriesRequest(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener){
        setValues();
        volleyLIbUtils=new VolleyLIbUtils(context,methodId,url,listener,errorListener);
    }
    private void setValues(){
        url= Constants.basicUrl+"/jobAdCategories";
